...
interface PrivacyInt {
  setPrivacy: any;
}

const Privacy: FC<PrivacyInt> = ({ setPrivacy }) => {
  const handleClose = () => {
    setPrivacy(false);
  };

  return (
    <div className="Privacy-Wrapper container section-padding">
      ...
      <p>
        ...
        <a href="https://werlive.co.il">werlive.co.il</a> website (“Website” or
      ...
      <h3 id="privacy-of-children">Privacy of children</h3>
      <p>
      ...
      <h3 id="use-and-processing-of-collected-information">
        Use and processing of collected information
      </h3>
      <p>
      ...
      <h3 id="retention-of-information">Retention of information</h3>
      <p>
      ...
      <h3 id="do-not-track-signals">Do Not Track signals</h3>
      <p>
      ...
      <h3 id="social-media-features">Social media features</h3>
      <p>
      ...
      <div onClick={handleClose} className="Privacy-Close">
        <Button text="Close" />
      </div>
